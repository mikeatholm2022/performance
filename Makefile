...
CXXFLAGS = -O3 -pthread -fPIC -fomit-frame-pointer -march=native -Wno-write-strings -ffloat-store -ffast-math -fno-math-errno -std=c++20 -DBOOST_BIND_GLOBAL_PLACEHOLDERS
